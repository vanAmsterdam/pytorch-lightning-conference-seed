...
class LIDCBaseline(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        df['label']   = df[hparams.outcome + '_binary']
    ...
    def add_model_specific_args(parent_parser, root_dir):
        ...
        parser.opt_list('--split_seed', default=1, type=int, tunable=False,
                        options=[1])
        ...
        parser.opt_list('--outcome', default='malignancy', type=str, tunable=True,
                        options = ['sublety', 'internalstructure', 'calcification', 'sphericity', 'margin', 'lobulation', 'spiculation', 'texture', 'malignancy'])
